...
Game = {
  ...
  FSM: {
    ...
    end_game: function () {
      ...
      Text.renderText(final_winner, 20, 370, 250);

      var final_score = 'Game Over ' + 'Player 1 Score is ' + Game.score;
      Text.renderText(final_score, 20, 370, 300);

      var final_score2 = 'Game Over ' + 'Player 2 Score is ' + Game.score2;
      Text.renderText(final_score2, 20, 370, 350);
...
$(function () {
  ...
  var mainLoop = function () {
    ...
    Text.renderText(score_text2, 18, Game.canvasWidth - 14 * score_text.length, 40);
    ...
    for (i = 0; i < Game.lives2; i++) {
      context.save();
      extraDude2.x = Game.canvasWidth - (8 * (i + 1));
      extraDude2.y = 72;
